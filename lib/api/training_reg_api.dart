...
class TrainingRegistrationAPI {
  Future<ResponseModel> postTrainingRegistration({Object? postBody}) async {
    DynamicRequest dynamicRequest = DynamicRequest();

    String path =
        ApiConstants.AddTrainingRegistration.replaceAll("{format}", "json");
  ...
  Future<ResponseModel> putTrainingRegistration({Object? postBody}) async {
    DynamicRequest dynamicRequest = DynamicRequest();

    String path =
        ApiConstants.UpdateTrainingRegistration.replaceAll("{format}", "json");
