...
class TrainingRegistrationAttendanceApi {
  Future<ResponseModel> getTrainingRegistrationAttendance(
      {String? registrationGuid, int? pageNumber, int? pageSize}) async {
    DynamicRequest dynamicRequest = DynamicRequest();

    String path = ApiConstants.trainingRegistrationAttendancePath
    ...
    if (data is Success) {
      TrainingRegistrationAttendance trainingParticipantList = dynamicRequest
          .deserialize(data.response!, 'TrainingRegistrationAttendance');
